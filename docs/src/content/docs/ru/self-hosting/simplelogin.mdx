...
![simplelogin](https://github.com/TeamDominant/wiki/blob/main/docs/src/assets/simplelogin/simplelogin.png?raw=true)
...
- Настоятельно рекомендуется настроить [Crowdsec](https://www.linuxserver.io/blog/blocking-malicious-connections-with-crowdsec-and-swag), [Geoblock](/ru/self-hosting/geoblock) и [Firehol](/ru/self-hosting/firehol).
