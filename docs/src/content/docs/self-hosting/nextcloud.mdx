---
title: "Optimizing Nextcloud"
description: "A step by step guide to optimize Nextcloud with SWAG, Redis, Collabora, and more."
---
...
![Nextcloud setup](https://github.com/TeamDominant/wiki/blob/main/docs/src/assets/nextcloud/nextcloud.png?raw=true)
