...
- Setting up [Crowdsec](https://www.linuxserver.io/blog/blocking-malicious-connections-with-crowdsec-and-swag), [Geoblock](/self-hosting/geoblock), and [Firehol](/self-hosting/firehol) is highly recommended.
