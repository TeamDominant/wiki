---
title: "SWAG"
description: "A guide to securing your SWAG reverse proxy."
---

import { Warning } from '@astrojs/starlight/components';
...
<Aside type="note">
This was removed by [author](https://github.com/quietsy/advanced-configurations), but I simply decided to leave it for personal purpose.
</Aside>
