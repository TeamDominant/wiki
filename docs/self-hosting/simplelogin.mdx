...
- Setting up [Crowdsec](https://www.linuxserver.io/blog/blocking-malicious-connections-with-crowdsec-and-swag), [Geoblock](/docs/self-hosting/geoblock), and [Firehol](/docs/self-hosting/firehol) is highly recommended.
