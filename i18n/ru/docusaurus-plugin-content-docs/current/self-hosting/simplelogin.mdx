...
- Настоятельно рекомендуется настроить [Crowdsec](https://www.linuxserver.io/blog/blocking-malicious-connections-with-crowdsec-and-swag), [Geoblock](/docs/self-hosting/geoblock) и [Firehol](/docs/self-hosting/firehol).
